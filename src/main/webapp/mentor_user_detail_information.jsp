...
<%
    String username = (String) request.getAttribute("mentor_username");
    int userID = (int) request.getAttribute("mentor_number");
...
<br>
<div align="center">
    <a class="btn btn-primary" href="mentorMainPageServlet">Return</a>
</div>
<br>
<div align="center" >
